...
import 'package:lelamonline_flutter/feature/status/view/widgets/tab_bar_widget.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Integrated TabBarWidget with dynamic height and seller-specific tabs
            SizedBox(
              height: 250, // Constrained height to fit in card; adjust as needed
              child: SellerTabBarWidget(
                // Pass ad-specific data if your custom widgets need it
                adData: ad,
                userId: widget.userId,
